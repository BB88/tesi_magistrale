...
\hline \hline
Position & Compression level & Both & Left & Right\\ \hline
0.3 & 1 & 30 & 30 & 30 \\
0.3 & 15 & 30 & 30 & 30 \\
0.3 & 25 & 10 & 15 & 10 \\
0.3 & 30 & 1 & 2 & 1 \\
...
\begin{center}
\scalebox{0.9}{ 
\begin{tabularx}{0.7\textwidth}{>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X}
\hline \hline
Position & Both & Left & Right\\ \hline
0.3 & 1 & 1 & 0\\
0.6 & 9 & 10 & 9\\
0.7 & 12& 14 & 12\\
\hline 
...
From the graphs of the $MQColor$ metric in Figures \ref{fig:gqmc} and \ref{fig:qml} we can see how the quality metric decrease when increasing the power of the watermark: it can be noted that the more the power of the watermark is high the more the quality of the perception is low.
...
\begin{tabularx}{0.7\textwidth}{>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X}
\hline \hline
CRF & Power & Detected frames \\ \hline
1& 0.3 & 30  \\
15& 0.3 & 29 \\
25& 0.3 & 11 \\
30& 0.3 & 2\\
...
\begin{tabularx}{0.7\textwidth}{>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X}
\hline \hline
Compression Level & Power & PSNR(dB) \\ \hline
1 & 0.3 & 44.4380 \\  	
1 & 0.5 & 42.5976 \\  
1 & 0.6 & 41.7071 \\   \hline				
15 & 0.3 & 42.5494 \\
15 & 0.5 & 41.2859 \\
15 & 0.6 & 40.6131 \\ \hline
25 & 0.3 & 39.4063  \\
25 & 0.5 & 38.9882  \\
25 & 0.6 &  38.7416 \\ \hline
YT & 0.3 & 37.8233  \\
YT & 0.5 & 37.7302  \\
YT & 0.6 & 37.6820  \\ \hline
30 & 0.3 & 36.9870  \\
30 & 0.5 & 36.7520  \\
30 & 0.6 & 36.6574 \\
\hline 
...
\caption{\small{Average PSNR values between original video and watermarked compressed videos with increasing value of compression and power.}\label{tab:psnr_glob}}
\end{center}
\end{table}
