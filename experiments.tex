...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
\includegraphics[width=0.8\textwidth]{./img/qm_left.png}
...
\label{fig:qmcl}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
\includegraphics[width=0.8\textwidth]{./img/qm_disp_left.png}
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
\includegraphics[width=0.8\textwidth]{./img/qm_right.png}
...
\label{fig:qmcr}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
\includegraphics[width=0.8\textwidth]{./img/qm_disp_right.png}
