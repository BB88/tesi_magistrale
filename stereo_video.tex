...
\begin{subfigure}[]{0.5\textwidth}
		\centering
        \includegraphics[width=0.7\textwidth]{./img/bin_pick.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
		\centering
        \includegraphics[width=0.7\textwidth]{./img/games1.jpg}
                \caption{\scriptsize{Stereo video frames, left and right.\newline}}
\end{subfigure}
\begin{subfigure}[]{0.4\textwidth}
		\centering
        \includegraphics[width=0.7\textwidth]{./img/games2.jpg}
                \caption{\scriptsize{Overlap of the two frames.}}
\end{subfigure} 
\begin{subfigure}[]{0.4\textwidth}
		\centering
        \includegraphics[width=0.7\textwidth]{./img/games3.jpg}
                \caption{\scriptsize{3D view with specific glasses.}}
\end{subfigure}%
\begin{subfigure}[]{0.4\textwidth}
		\centering
        \includegraphics[width=0.7\textwidth]{./img/games4.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.3\textwidth]{./img/interaxial-separation.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/syderig.jpg}
...
\centering
\includegraphics[width=0.7\textwidth]{./img/mirrorrig.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/monorig.jpg}
...
\item[-] monoblock cameras have been designed as well, where the two cameras are presented in a fixed block
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/devices1.jpg}
...
\begin{subfigure}[]{0.25\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/devices2.jpg}
\caption{\scriptsize{Digital cameras.}}
\end{subfigure} 
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/devices3.jpg}
\caption{\scriptsize{Camcorders.}}
\end{subfigure}%
\caption{\small{Digital personal stereo acquisition systems.}}\label{fig:mobile}
\end{figure}
An other important category of 3D image capture devices it's the one employed in the robotics and automation field, Figure \ref{industrial}, \cite{BUMBLE}\cite{AUTO}. They are usually impressively precise, cost-efficient and fast.
\begin{figure}[h!]
\centering
\begin{subfigure}[]{0.4\textwidth}
\centering
...
\centering
\includegraphics[width=0.7\textwidth]{./img/stereodevices.jpg}
...
\begin{subfigure}[b]{0.35\textwidth}
        \includegraphics[width=\textwidth]{./img/hvs.jpg}
         \caption{\scriptsize{Binocular human visual system.}}
         \label{fig:hvs}
\end{subfigure}
\begin{subfigure}[b]{0.35\textwidth}
        \includegraphics[width=\textwidth]{./img/stereo.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{./img/correspondance.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{./img/stereo_system.jpg}
\caption{\small{Stereo camera model.}}
\label{fig:rt}
\end{figure}
These parameters can be used to rectify a stereo pair of images to make them appear as the two image planes are parallel (Figure \ref{fig:rect_stereo}); once the images are rectified, epipolar geometry it's used to find corresponding points and compute the disparity map\cite{ZISS}.
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{./img/rect_stereo.jpg}
\caption{\small{Rectified stereo cameras.}}
\label{fig:rect_stereo}
\end{figure}
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{./img/standard.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{./img/depth.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{./img/left.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{./img/right.jpg}
\caption{\scriptsize{Right image.}}
\end{subfigure} 
~\quad
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{./img/disparity.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{./img/occl.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{./img/local.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{./img/gf1.jpg}
\caption{\scriptsize{Left image.}}
\end{subfigure}% 
~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.$  $
  %(or a blank line to force the subfigure onto a new line)
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{./img/gf2.jpg}
\caption{\scriptsize{Graph cuts' disparity map.}}
\end{subfigure} 
~\quad
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.8\textwidth]{./img/gf3.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/tv1.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/glass1.jpg}
...
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/glass2.jpg}
\caption{\scriptsize{Polarized glasses.}}
\label{fig:glass2}
\end{subfigure} 
\begin{subfigure}[]{0.4\textwidth}
\centering
\includegraphics[width=0.7\textwidth]{./img/glass3.jpg}
\caption{\scriptsize{Anaglyph glasses.}}
\label{fig:glass3}
\end{subfigure}%
